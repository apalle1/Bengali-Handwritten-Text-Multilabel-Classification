...
Original file is located at
    https://colab.research.google.com/drive/18gt8UohjSOAoTOspyQMWcHDLm8aB01ww
"""
...
def evaluate(dataset, data_loader, model):
    # This function doesn't expect optimizer as input
...
def main():
    ...
    # "Differential learning rates" can be implemented
    # Setting different learning rates for different parts of the network during our training.
    optimizer = torch.optim.Adam(model.parameters(), lr=1e-4)

    # Learning rate scheduler - https://discuss.pytorch.org/t/what-does-scheduler-step-do/47764/4
    ...
    # Implementation - https://github.com/Bjarten/early-stopping-pytorch/blob/master/pytorchtools.py
    for epoch in range(1, EPOCHS+1):

        train_loss, train_score = train(train_dataset,train_data_loader, model, optimizer)
        val_loss, val_score = evaluate(valid_dataset, valid_data_loader, model)
